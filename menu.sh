...
echo -e "* add-trojan      : membuat akun trojan"
echo -e "* hapus-trojan    : hapus akun trojan"
echo -e "* renew-trojan    : perpanjang akun trojan"
echo -e "* add-v2ray       : membuat akun v2ray"
echo -e "* hapus-v2ray     : hapus akun v2ray"
echo -e "* renew-v2ray     : perpanjang akun v2ray"
